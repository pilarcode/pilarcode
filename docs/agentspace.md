...
- [NotebookLM & AgentSpace ](https://www.youtube.com/watch?v=3Wo-iucic7I&t=1s)
  ...
  Agent Space, es una plataforma donde puedes interactuar con todos tus datos y agentes para acabar con los silos de información mediante las mejores técnicas de búsqueda, genAI y Agentes.Muchas empresas actualmente usan muchas herramientas basadas en AI pero están fragmentadas. 

  <img width="888" height="456" alt="image" src="https://github.com/user-attachments/assets/818c1b60-c50b-449f-9b81-e3f19d38be5d" />

Agentspace, es un producto de software como servicio totalmente gestionado, que actua como un centro de información centralizado para una organización. Es como si fuera una búsqueda en Google pero con todo lo que ocurre de una  empresa. Se pueden crear motores de búsqueda internos empresariales y agentes de búsqueda que trabajen con tus datos. Puedes acceder a distintas fuentes de datos mediante los conectores de agent space.
